                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="font-xs">
                                    <ul>
                                        <li class="mb-5">P-Code: <span class="text-brand" id="pcode" ></span></li>
                                        <li class="mb-5">Stock: <span class="badge badge-pill bagde-success" id="available" style="background: green; color:white;"></span>
                                        <span class="badge badge-pill bagde-success" id="stockout" style="background: red; color:white;"></span></li>
                                    </ul>
                                    </div>
                                    </div>
                                </div>
