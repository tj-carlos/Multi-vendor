...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Vendor Active Details</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Vendor Active Details</li>
							</ol>
						</nav>
					</div>
				</div>
						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="card-body">
                                    ...
                                    <form method="post" action="{{ route('diactivate.vendor.approve')}}" > 
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
                                            <textarea class="form-control" name="vendor_short_info" id="inputAddress2" placeholder="Address" rows="3">{{ $activeVendorDetails->vendor_short_info}}</textarea>
											</div>
										</div>
                                        <div class="row mb-3">
											<div class="col-sm-3">
										...
										<div class="row">
											...
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-danger px-4" value="Diactivate Vendor" />
											</div>
										</div>
									</div>
                                </form>
