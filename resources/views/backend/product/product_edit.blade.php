...
<form id="myForm" method="post" action="{{ route('update.product') }}"  >
	...
	<div class="col-md-6">	
    <div class="form-check">	<input class="form-check-input" name="featured" type="checkbox" value="1" id="flexCheckDefault" {{ $products->featured == 1 ? 'checked' : '' }}>
			<label class="form-check-label" for="flexCheckDefault">Featured</label>
		</div>
	</div>
    <div class="col-md-6">	
    <div class="form-check"><input class="form-check-input" name="special_offer" type="checkbox" value="1" id="flexCheckDefault" {{ $products->special_offer == 1 ? 'checked' : '' }}>
    ...
    <div class="card">
        <form method="post" action="{{ route('update.product.thambnail') }}" enctype="multipart/form-data" > 
            ...
            <div class="mb-3">
                ...
                <input name="product_thambnail" class="form-control" type="file" id="formFileMultiple" multiple="">
            </div>
            <div class="mb-3">
...
<div class="page-content">
    <h6 class="mb-0 text-uppercase">Update Malti Image</h6>
    <hr>
<div class="card">
    <div class="card-body">
